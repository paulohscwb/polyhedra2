...
/***/ (function(module, exports, __webpack_require__) {
	...
	const GraphBufferGeometry = __webpack_require__(2);
	...
	AFRAME.registerComponent('plot', {
	    ...
	    schema: {
	        ...
	        'grid_x_scale': {'type': 'number', 'default': 0.1}, // TODO
	...
	function makeZeroPlanes(bounds) {
	    ...
	    zeroPlaneMaterial.opacity = 1 / 9;
		zeroPlaneMaterial.depthTest = false;
	...
	function makeBoundingBox(bounds) {
	    ...
	    boundingMaterial.opacity = 1 / 9;
	    boundingMaterial.depthTest = false;
	...
	function createGraphObject(valueFunction, order, bounds, color, gridXScale, gridZScale, showGrid) {
	    ...
	    var material = new THREE.MeshStandardMaterial(materialProperties);
